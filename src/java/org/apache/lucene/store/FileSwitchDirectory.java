...
public class FileSwitchDirectory extends BaseDirectory {
  private final Directory secondaryDir;//第二优先级目录
  private final Directory primaryDir;//优先级目录
  private final Set<String> primaryExtensions;//优先级扩展名集合，扩展名在该集合内的文件要操作primaryDir目录,否则操作secondaryDir目录
  private boolean doClose;//是否完成操作后关闭目录
